...
export class Office365OutlookService {
   ...
   * Create a webhook subscription for the trigger when a new email arrives.
   */
  public static async CreateOnNewEmailPokeSubscription(subscription: ClientSubscription, folderPath?: string, importance?: 'Any' | 'Low' | 'Normal' | 'High', fetchOnlyWithAttachment?: boolean): Promise<IOperationResult<void>> {
    const params: { subscription: ClientSubscription, folderPath?: string, importance?: 'Any' | 'Low' | 'Normal' | 'High', fetchOnlyWithAttachment?: boolean } = { subscription, folderPath, importance, fetchOnlyWithAttachment };
    const result = await Office365OutlookService.client.executeAsync<{ subscription: ClientSubscription, folderPath?: string, importance?: 'Any' | 'Low' | 'Normal' | 'High', fetchOnlyWithAttachment?: boolean }, void>(
      {
        connectorOperation: {
          tableName: Office365OutlookService.dataSourceName,
   ...
   * Create a Graph webhook subscription for the trigger when a new email arrives.
   */
  public static async CreateGraphOnNewEmailPokeSubscription(subscription: ClientSubscription, folderPath?: string, importance?: 'Any' | 'Low' | 'Normal' | 'High', fetchOnlyWithAttachment?: boolean): Promise<IOperationResult<void>> {
    const params: { subscription: ClientSubscription, folderPath?: string, importance?: 'Any' | 'Low' | 'Normal' | 'High', fetchOnlyWithAttachment?: boolean } = { subscription, folderPath, importance, fetchOnlyWithAttachment };
    const result = await Office365OutlookService.client.executeAsync<{ subscription: ClientSubscription, folderPath?: string, importance?: 'Any' | 'Low' | 'Normal' | 'High', fetchOnlyWithAttachment?: boolean }, void>(
      {
        connectorOperation: {
   ...
   */
  public static async CreateOnNewMentionMeEmailPokeSubscription(subscription: ClientSubscription, folderPath?: string, importance?: 'Any' | 'Low' | 'Normal' | 'High', fetchOnlyWithAttachment?: boolean): Promise<IOperationResult<void>> {
    const params: { subscription: ClientSubscription, folderPath?: string, importance?: 'Any' | 'Low' | 'Normal' | 'High', fetchOnlyWithAttachment?: boolean } = { subscription, folderPath, importance, fetchOnlyWithAttachment };
    const result = await Office365OutlookService.client.executeAsync<{ subscription: ClientSubscription, folderPath?: string, importance?: 'Any' | 'Low' | 'Normal' | 'High', fetchOnlyWithAttachment?: boolean }, void>(
      {
        connectorOperation: {
   ...
   */
  public static async CreateGraphOnNewMentionMeEmailPokeSubscription(subscription: ClientSubscription, folderPath?: string, importance?: 'Any' | 'Low' | 'Normal' | 'High', fetchOnlyWithAttachment?: boolean): Promise<IOperationResult<void>> {
    const params: { subscription: ClientSubscription, folderPath?: string, importance?: 'Any' | 'Low' | 'Normal' | 'High', fetchOnlyWithAttachment?: boolean } = { subscription, folderPath, importance, fetchOnlyWithAttachment };
    const result = await Office365OutlookService.client.executeAsync<{ subscription: ClientSubscription, folderPath?: string, importance?: 'Any' | 'Low' | 'Normal' | 'High', fetchOnlyWithAttachment?: boolean }, void>(
      {
        connectorOperation: {
   ...
   * Create an Outlook webhook subscription for the trigger when an email is flagged.
   */
  public static async CreateOnFlaggedEmailPokeSubscription(subscription: ClientSubscription, folderPath?: string, importance?: 'Any' | 'Low' | 'Normal' | 'High', fetchOnlyWithAttachment?: boolean): Promise<IOperationResult<void>> {
    const params: { subscription: ClientSubscription, folderPath?: string, importance?: 'Any' | 'Low' | 'Normal' | 'High', fetchOnlyWithAttachment?: boolean } = { subscription, folderPath, importance, fetchOnlyWithAttachment };
    const result = await Office365OutlookService.client.executeAsync<{ subscription: ClientSubscription, folderPath?: string, importance?: 'Any' | 'Low' | 'Normal' | 'High', fetchOnlyWithAttachment?: boolean }, void>(
      {
        connectorOperation: {
   ...
   * Create a Graph webhook subscription for the trigger when an email is flagged.
   */
  public static async CreateGraphOnFlaggedEmailPokeSubscription(subscription: ClientSubscription, folderPath?: string, importance?: 'Any' | 'Low' | 'Normal' | 'High', fetchOnlyWithAttachment?: boolean): Promise<IOperationResult<void>> {
    const params: { subscription: ClientSubscription, folderPath?: string, importance?: 'Any' | 'Low' | 'Normal' | 'High', fetchOnlyWithAttachment?: boolean } = { subscription, folderPath, importance, fetchOnlyWithAttachment };
    const result = await Office365OutlookService.client.executeAsync<{ subscription: ClientSubscription, folderPath?: string, importance?: 'Any' | 'Low' | 'Normal' | 'High', fetchOnlyWithAttachment?: boolean }, void>(
      {
        connectorOperation: {
