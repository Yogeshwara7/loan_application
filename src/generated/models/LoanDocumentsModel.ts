...
export interface LoanDocumentsBase {
  ID?: number;
  Title?: string;
  Modified?: string;
...
export interface LoanDocumentsRead extends LoanDocumentsBase {
  Editor?: EditorValue;
  Author?: AuthorValue;
  CheckoutUser?: CheckoutUserValue;
}

export interface LoanDocumentsWrite extends LoanDocumentsBase {
  Editor?: EditorValue;
  Author?: AuthorValue;
  CheckoutUser?: CheckoutUserValue;
}
