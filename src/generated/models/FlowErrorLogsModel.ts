...
export interface FlowErrorLogsBase {
  ID?: number;
  Title?: string;
  Applicant_x0020_Name?: string;
...
export interface FlowErrorLogsRead extends FlowErrorLogsBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}

export interface FlowErrorLogsWrite extends FlowErrorLogsBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}
