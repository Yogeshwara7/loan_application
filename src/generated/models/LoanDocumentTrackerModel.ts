...
export interface LoanDocumentTrackerBase {
  ID?: number;
  Title?: string;
  FileName?: string;
  UploadedBy?: string;
...
export interface LoanDocumentTrackerRead extends LoanDocumentTrackerBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}

export interface LoanDocumentTrackerWrite extends LoanDocumentTrackerBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}
